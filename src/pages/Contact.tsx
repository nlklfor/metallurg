...
export default function Contact() {
  return (
    <div className="w-full min-h-screen bg-white flex flex-col">
      ...
      <div className="px-4 sm:px-8 pb-10 sm:pb-16">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
          {/* Left — Contact Info */}
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-[9px] sm:text-[10px] text-gray-300 tracking-[0.28em] sm:tracking-[0.4em] uppercase">
                // CHANNELS
              </p>
              ...
              <a
                ...
                className="flex items-center gap-3 sm:gap-4 group border border-gray-200 p-4 sm:p-5 hover:border-black transition-all"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-black flex items-center justify-center group-hover:scale-105 transition-transform">
                ...
                <div>
                  ...
                  <p className="text-[8px] sm:text-[10px] text-gray-400 tracking-[0.18em] sm:tracking-[0.2em]">
                    @metallurg.tm
                  </p>
                </div>
            ...
            <div className="border border-gray-200 p-4 sm:p-6 space-y-2 sm:space-y-3">
              <p className="text-[9px] sm:text-[10px] text-gray-300 tracking-[0.28em] sm:tracking-[0.4em] uppercase">
                // RESPONSE_TIME
              </p>
              ...
              <div className="flex items-center gap-2 pt-1 sm:pt-2">
                ...
                <span className="text-[8px] sm:text-[9px] text-gray-400 tracking-[0.22em] sm:tracking-[0.3em] uppercase">
                  STATUS: ONLINE
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center">
            <p className="text-[7px] sm:text-[8px] text-gray-300 tracking-[0.28em] sm:tracking-[0.4em] uppercase mb-4 sm:mb-6">
              // PREVIEW_FEED
            </p>
            <div className="w-[220px] sm:w-[320px] dark">
              <Iphone src={phone} />
            </div>
          </div>
        </div>
